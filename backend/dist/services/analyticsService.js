...
exports.recalculateAnalytics = exports.getAnalyticsMetrics = void 0;
const db_1 = require("../config/db");
const getAnalyticsMetrics = async (category, country) => {
...
exports.getAnalyticsMetrics = getAnalyticsMetrics;
const recalculateAnalytics = async (category, country) => {
    // Fetch the last 12 months of movement_days from visa_bulletin_history
    const historyQuery = await (0, db_1.query)(`SELECT movement_days, final_action_date 
       FROM visa_bulletin_history 
       WHERE category = $1 AND country = $2 AND movement_days IS NOT NULL
       ORDER BY bulletin_month DESC LIMIT 12`, [category, country]);
    ...
    await (0, db_1.query)(`INSERT INTO prediction_cache 
       ...
       DO UPDATE SET 
          ...
          last_calculated_at = NOW()`, [category, country, avgMovement.toFixed(2), regressionSlope.toFixed(4), confidenceLevel, estimatedMonthsToCurrent]);
};
exports.recalculateAnalytics = recalculateAnalytics;
